...
export const Basics = ({ eKYCId }) => {
    ...
    const [token, setToken] = useState("007eJxTYDiTcV9L+2Pmrk0fnrbuu+jZ/2z55Q9dH83ET8+OFN0ZxF+qwGBhkZhkYWiZZmmQlmRikJScZG6WlpSYlGxgYGSclmiaUlxgn94QyMjQr3OIgREKQXwWhtTsymQGBgBcsiKA");
